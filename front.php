...
<body style="background-image:url('./images/bg6.JPG');align-center;height:0%;display:block;">">
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#" id = "lii"><strong>Acronton Technology Private limited</strong></a>
    </div>
...
<div class="col-sm-3" style="padding-left:50px;padding-top:00px;height:40%;"> 

 <div><h3 style="color:#FFFFFF;" >Check Out Visitor</h3></div>
...
<label class="control-label" id ="t" for="recept_id" style="color:orangered">Receipt ID :</label>
 
<input class = "form-control" name= "rid" type = "number"  placeholder="Enter your Receipt-ID to check Status." required/>
...
<h1 style="padding-left:10px;padding-top:0px;font-family:Georgia;text-align:center;background-color:#afeeee;">WELCOME TO ACRONTON</h1>
<h1 style="padding-left:10px;padding-top:0px;font-family:Georgia;text-align:center;background-color:#afeeee;">Enter your details</h1>
...
<h3 style="color:yellow;margin-right;auto;padding-left:40px">Recent Visitors Present already:&nbsp;<?php echo $onlineVsitor;?></h3>
