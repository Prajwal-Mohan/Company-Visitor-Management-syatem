...
.affix {
  ...
  #button{padding-top: 20px;}
	...
	<body style="background-image:url('./images/bg12.JPG');>
...
<!--   Navigation Menu   -->
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li ><a  id = "li"href="myform.php" id = "li">Add Visitor</a></li>
      <li><a  id = "li"href="logoutform.php" id = "li">Checked Out Visitors</a></li>
      <li class="active"><a href="query_data.php">View Data</a></li> 
      <li><a  id = "li"href="logout.php" id = "li">Logout</a></li> 
    </ul>
  </div>
</nav>
	...
	<div id='body'>
		...
		<h2 style="color:WHITE;">Search By  </h2>
		<script>
		function undisable() {
		...
		<div class="FormLabel" style="border-top: solid 2px;color:yellow;">		
		 ...
		 <div style="border-bottom: solid 2px;padding-bottom: 12px;color:yellow;">
